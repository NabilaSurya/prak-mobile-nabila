...
// Import di bawah ini otomatis menyesuaikan dengan file layout XML Anda (misal: fragment_tabc.xml)
import com.example.nabeeyaps.databinding.FragmentTabCBinding

class TabCFragment : Fragment() {
    // Catatan: Pastikan huruf 'c' sesuai dengan nama layout XML Anda (biasanya FragmentTabcBinding)
